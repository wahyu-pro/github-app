...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>{
    ...
    public FavoriteAdapter.FavoriteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavoriteAdapter.FavoriteViewHolder(mView);
    }
    ...
    public void onBindViewHolder(@NonNull FavoriteAdapter.FavoriteViewHolder holder, int position) {
        ...
        holder.ivDelete.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_scale_animation));
        ...
        holder.ivDelete.setOnClickListener(v -> {
            onItemClickCallback.onDeleteFavorite(mData.get(holder.getAdapterPosition()));
        });
    ...
    public static class FavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        public FavoriteViewHolder(@NonNull View itemView) {
            super(itemView);
            avatar = itemView.findViewById(R.id.img_user_fav);
            username = itemView.findViewById(R.id.tv_username_fav);
    ...
    public interface OnItemClickCallback {
        ...
        void onDeleteFavorite(Favorite data);
    }
}
